...
import "@openzeppelin/contracts-upgradeable/utils/introspection/ERC165Upgradeable.sol"; //See EIP165 - common interface standard
import "@openzeppelin/contracts-upgradeable/token/common/ERC2981Upgradeable.sol"; //See EIP2981 - NFT Royalty standard

import "./INFT_DB.sol"; //ERCPlatform Custom Interface, contracts should support interface this

/**
 * @dev INFT_DB decentralized database for custodial NFTs - with royalties attributes - for customers.
 */
contract royaltiesNFT_DB is
    Initializable,
    ERC165Upgradeable,
